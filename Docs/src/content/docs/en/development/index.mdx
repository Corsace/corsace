...
:::note
In Linux/WSL while using the binary itself, you may need to run `chmod +x centrifugo` to be able to properly run the binary executable, as otherwise it may give an error similar to this:
```
