...
:::danger
Implementation of this feature is in a very primitive stage. This will currently only work for tournaments with a qualifier stage that also allows users to schedule them to whenever they want. Registration into a tournament currently implies that the user/team is scheduling for a qualifier as well. 
:::
