...
Push all your changes into your forked repository, and create a Pull Request. Ping VINXIS (`corsace.io` or `vinxis` on discord) or ThePooN (`thepoon` on discord) in the #dev channel in the [Corsace Discord Server](https://discord.gg/Z6vEMsr)
