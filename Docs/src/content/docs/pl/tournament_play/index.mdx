...
Aby dołączyć do drużyny przez stronę internetową, przejdź na [stronę Corsace Open](https://open.corsace.io) i zaloguj się. Po zalogowaniu się, trzy linie menu powinny mieć czerwoną kropkę, jeśli kapitan już cię zaprosił. Kliknij menu -> zaproszenia, aby przejść do strony z zaproszeniami do drużyny. The invitations option should also have a red dot if you have any pending invites.
