...
*   **[Frontend/Client](#frontendclient)**
    *   **[AYIM/Closed/MCA/Main/Open](../client/guide/web-running-environment)** - Made with [Nuxt 2](https://v2.nuxt.com/)
    *   **[Docs](../client/guide/docs-running-environment)** - Made with [Astro/Starlight](https://starlight.astro.build/)
...
*   [Backend/Server](#backendserver)
    ...
    *   **[Server/CronRunner](#)** - Made with [Koa](https://koajs.com/)
    *   **[Centrifugo](#)** - Made with [Centrifugo](https://centrifugal.dev/)
