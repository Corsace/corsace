...
Berkas store utama terletak pada `Assets/store/index.ts`. Untuk mengakses variabel tertentu dari state-nya masing-masing, kamu dapat menambahkan rangkaian kode berikut pada bagian `script`:
