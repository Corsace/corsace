...
Push seluruh perubahan yang kamu buat ke repositori milikmu dan buat Pull Request baru. Setelahnya, ping VINXIS (`corsace.io` atau `vinxis` di Discord) atau ThePooN (`thepoon` di discord) pada channel #dev di [server Discord Corsace](https://discord.gg/Z6vEMsr).
