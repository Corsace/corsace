...
Tempatkan seluruh gambar pada direktori `Docs/src/images`. Kamu akan dapat menyisipkan gambar-gambar ini ke dokumenmu melalui tautan relatif (relative link).
Untuk mengakses gambar di `Docs/src/images` dari dokumen ini (yang berlokasi di `Docs/src/content/docs/en/development/Client/Guide/docs-write-edit-documents.mdx`), tautan relatif yang kamu butuhkan adalah sebagai berikut:
