...
Setelah kamu membuat turnamen, kamu dapat meneruskan ke [membuat tahapan dan ronde](./stage-round-creation) untuk turnamenmu, yang kemudian dilanjutkan dengan [membuat mappool](./mappool-creation) untuk masing-masing tahapan dan ronde.
