...
Langkah pertama adalah untuk membuat turnamen. Use the `/tournament_create` command in any channel in the server where you want the tournament to be created. Ensure you fill in all the required parameters.
