...
Untuk mengikuti turnamen, gunakan perintah `/tournament_qualifier` pada salah satu channel beserta dengan tanggal dan waktu kamu ingin memainkan pertandingan kualifikasi.
