...
export default class Results extends Vue {
    ...
    columns: ResultColumn[] = [
        {label: "placement", size: 1, category: "beatmaps", prio: true}, 
        {label: "placement", size: 4, category: "users", prio: true},
        {label: "map", size: 6, category: "beatmaps", mobileOnly: true},
        {label: "title", size: 5.5, category: "beatmaps", desktopOnly: true},
        {label: "artist", size: 3.75, category: "beatmaps", desktopOnly: true},
        {label: "hoster", size: 2, category: "beatmaps", desktopOnly: true},
        {label: "username", size: 8.25, msize: 6, category: "users"},
        {label: "firstChoice", size: 2, centred: true, prio: true},
        {label: "secondThirdChoice", size: 2, desktopOnly: true, centred: true},
        {label: "restChoice", size: 2, desktopOnly: true, centred: true},
    ]
