...
export default class Results extends Vue {
    ...
    columns: ResultColumn[] = [
        ...
        {label: "title", size: 5, category: "beatmaps", desktopOnly: true},
        {label: "artist", size: 5, category: "beatmaps", desktopOnly: true},
        {label: "hoster", size: 4, category: "beatmaps", desktopOnly: true},
