...
export class initial1614220134368 implements MigrationInterface {
    ...
    public async up (queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `category` (`ID` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, `maxNominations` int NOT NULL, `requiresVetting` tinyint NOT NULL DEFAULT 0, `type` enum ('0', '1') NOT NULL DEFAULT '0', `modeID` int NOT NULL, `mcaYear` year NOT NULL, `filterMinlength` int NULL, `filterMaxlength` int NULL, `filterMinbpm` int NULL, `filterMaxbpm` int NULL, `filterMinsr` int NULL, `filterMaxsr` int NULL, `filterMincs` int NULL, `filterMaxcs` int NULL, `filterRookie` tinyint NULL, PRIMARY KEY (`ID`)) ENGINE=InnoDB");
