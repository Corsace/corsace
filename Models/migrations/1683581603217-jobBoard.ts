...
export class jobBoard1683581603217 implements MigrationInterface {
    ...
    public async up (queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`job_post\` (\`ID\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`description\` varchar(255) NOT NULL, \`jobBoardThread\` varchar(255) NULL, \`createdByID\` int NULL, PRIMARY KEY (\`ID\`)) ENGINE=InnoDB`);
