...
export class MatchupMessages1688054271673 implements MigrationInterface {
    ...
    public async up (queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`matchup_message\` (\`ID\` int NOT NULL AUTO_INCREMENT, \`timestamp\` datetime NOT NULL, \`content\` text NOT NULL, \`userID\` int NULL, \`matchupID\` int NULL, PRIMARY KEY (\`ID\`)) ENGINE=InnoDB`);
