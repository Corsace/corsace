...
@Component({
    ...
    head () {
        return {
            ...
            meta: [
                { name: "description", content: "The records related to mappers in A Year in Mapping." },
                { property: "og:title", content: "Mappers' Records | AYIM" },
                { property: "og:type", content: "website" },
                { property: "og:url", content: "https://ayim.corsace.io" },
                { property: "og:description", content: "The records related to mappers in A Year in Mapping." },
