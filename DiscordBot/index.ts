...
(async () => {
    ...
    .then(() => console.log(`Successfully refreshed ${commands.length} slash (/) commands`))
    .catch((error) => console.error("An error has occurred in refreshing slash (/) commands", error));

// Start the bot
ormConfig.initialize()
    .then((connection) => console.log(`Connected to the ${connection.options.database} database`))
